/* global describe beforeEach before it context  */
...
describe('RequestHandlers.js', function () {
  ...
  describe('handleCreateRepositoryRequest', function () {
    var createRepositoryStub, gitHubClientMock
    beforeEach(function () {
  ...
  describe('handleListRepositoryRequest', function () {
    var listMyRepositoriesStub, gitHubClientMock
    beforeEach(function () {
  ...
  describe('handleListAllMyOpenIssuesRequest', function () {
    var listAllMyOpenIssuesStub, gitHubClientMock
    beforeEach(function () {
  ...
  describe('handleGetLatestCommitRequest', function () {
    context('when slots are valid', function () {
      var gitHubClientMock, listMyRepositoriesStub, getLatestCommitStub
      beforeEach(function () {
        listMyRepositoriesStub = sinon.stub()
